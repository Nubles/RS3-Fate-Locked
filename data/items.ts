...
export const EQUIPMENT_SLOTS = [
  'Head', 'Cape', 'Neck', 'Ammo', 'Weapon', 'Body', 'Shield', 'Legs', 'Gloves', 'Boots', 'Ring', 'Pocket', 'Aura'
];

export const MOBILITY_LIST = [
  'Lodestone Network', 'Fairy Rings', 'Spirit Trees', 'Gnome Gliders', 'Charter Ships', 
  'Passage of the Abyss', 'Jewelry Teleports', 'Canoes', 'Balloon Transport', 'Mine Carts', 
  'Wilderness Obelisks', 'Minigame Teleports', 'Dungeoneering Ring', 'Quetzal Network',
  'Slayer Ring', 'Ectophial', 'Crystal Teleport Seed', 'Royal Seed Pod',
  'Ring of Fortune', 'Passage Teleport', 'Enchanted Lyre', 'Ring of the Elements',
  'Digsite Pendant', 'Games Necklace', 'Ring of Dueling', 'Combat Bracelet', 'Mycelium Transport', 'Eagle Transport', 'Xeric\'s Talisman', 'Drakan\'s Medallion', 'Pharaoh\'s Sceptre', 'Magic Carpets', 'Camulet', 'Kharedst\'s Memoirs'
];
...
export const MERCHANTS_LIST = [
  ...
  'Weapon Shops', 'Reward Shops', 'Invention Components', 'Archaeology Materials',
  'Necromancy Shrouds'
];

export const STORAGE_LIST = [
  'Ore Box', 'Material Storage', 'Coin Pouch', 'Rune Pouch', 'Seed Box', 'Herb Sack', 'Gem Bag', 'Coal Bag', 'Fish Barrel', 
  ...
  'Spice Pouch', 'Seed Vault', 'Fossil Storage', 'Colossal Pouch', 'Gricoller\'s Can', 'Dizana\'s Quiver', 'Forestry Kit', 'Flamtaer Bag'
];
...
export const GUILDS_LIST = [
  ...
  'Myths\' Guild', 'Ranging Guild', 'Warriors\' Guild', 'Wizards\' Guild', 'Woodcutting Guild',
  'Invention Guild', 'Archaeology Guild', 'Servants\' Guild'
];

export const SLAYER_UNLOCKS_LIST = [
  'Slayer Helmet', 'Broad Arrow Fletching', 'Ring Bling', 'Bigger and Badder',
  'Like a Boss', 'Task Storage', 'Gargoyle Smasher', 'Slug Salter', 'Reptile Freezer',
  'Reaper Tasks', 'Ability Codex Unlocks'
];

export const FARMING_PATCH_LIST = [
  'Allotment', 'Herb', 'Flower', 'Hops', 'Bush', 'Wood Tree', 
  'Fruit Tree', 'Hardwood Tree', 'Cactus', 'Mushroom', 'Spirit Tree', 'Elder Tree', 'Belladonna', 'Seaweed', 'Calquat', 'Celastrus', 'Redwood', 'Crystal Tree', 'Hespori Patch', 'Anima', 'Vinery', 'Coral Nursery'
];

export const FARMING_UNLOCK_DETAILS: Record<string, string> = {
  'Allotment': "Potatoes, Cabbages, Watermelons",
  'Herb': "Guam, Ranarr, Torstol, Fellstalk",
  'Flower': "Marigold, Nasturtium, Woad",
  'Hops': "Barley, Krandorian, Wildblood",
  'Bush': "Redberry, Poison Ivy, Wishing Well Bush",
  'Wood Tree': "Oak, Willow, Maple, Yew, Magic",
  'Fruit Tree': "Apple, Banana, Orange, Palm",
  'Hardwood Tree': "Teak, Mahogany",
  'Cactus': "Cactus Spine, Potato Cactus",
  'Mushroom': "Bittercap, Spirit Mushroom",
  'Spirit Tree': "Teleport Network",
  'Elder Tree': "Elder Logs"
};
...
export const REGION_GROUPS: Record<string, string[]> = {
  ...
  'Karamja': [
    ...
    'Mor Ul Rek (TzHaar City)', 'Crandor', 'Ship Yard'
  ],
  'Kharidian Desert': [
  ...
  'Morytania': [
    ...
    'Mos Le\'Harmless', 'Braindeath Island', 'Dragontooth Island', 'Icyene Graveyard'
  ],
  'Fremennik': [
    'Rellekka', 'Neitiznot', 'Jatizso', 'Miscellania & Etceteria', 'Waterbirth Island', 
    'Lunar Isle', 'Mountain Camp', 'Lighthouse', 'Keldagrim', 'Weiss', 'Pirates\' Cove'
  ],
  'Tirannwn': [
  ...
  'Daemonheim': [
    'Daemonheim Peninsula', 'Frozen Floors', 'Abandoned Floors', 'Furnished Floors', 'Occult Floors', 'Warped Floors', 'Daemonheim Castle', 'Catacombs of Daemonheim'
  ],
  'Anachronia': [
    'Anachronia Base Camp', 'Lazul Outpost', 'Archaeology Digsite (Anachronia)', 'Agility Course (Anachronia)', 'Slayer Dungeon (Anachronia)'
  ],
  'City of Um': [
    'Underworld', 'Ritual Site', 'Um Docks', 'Necryo Tomb', 'Soul Well'
  ],
  'Eastern Isles': [
    'Aminishi', 'Tuai Leit', 'Gielinor\'s Edge', 'Waiko', 'Whale\'s Teeth', 'Turtle Islands'
  ],
  'Senntisten': [
    'Cathedral', 'Asylum', 'Senntisten Graveyard', 'Zarosian Crypts' ]
  ,
  // --- Legacy OSRS Regions (for validation compatibility) ---
  'Kourend & Kebos': [
  ...
  'Varlamore': [
    ...
    'Hunter\'s Guild', 'Aldarin', 'The Stranglewood', 'Tlati Rainforest', 'Auburnvale', 'Mistrock', 'Sunset Coast'
  ],
  'Islands & Others': [
    'Fossil Island', 'Ape Atoll', 'Zanaris', 'Tutorial Island', 'Isle of Souls', 'Lithkren'
  ],
  'The Open Seas': [
    ...
    'Brittle Isle', 'Grimstone', 'Red Rock', 'Last Light', 'The Summer Shore'
  ]
};;
